...
import service from '../../assets/product_1746_3_thumb.jpg'
  ...
  return (
     <div className="max-w-6xl mx-auto p-4">
          ...
          <div className="bg-white shadow rounded p-4 mb-6">
            <h2 className="text-gray-700 font-semibold">Product Booking ID - 1239564261565</h2>
            <div className="flex items-center gap-4 mt-2">
              ...
              />
              <div>
                <h3 className="text-lg font-semibold">Water Purifier</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="col-span-3 bg-white shadow rounded p-6">
              ...
              <ol className="relative border-l border-gray-300">
                ...
                <li className="mb-10 ml-4">
                  <div className="absolute w-3 h-3 bg-green-500 rounded-full -left-1.5 top-1.5" />
                  <h4 className="font-bold">Your Item has been picked up by delivery partner.</h4>
                  <p className="text-sm text-gray-600">Seller has given your parcel to delivery partner</p>
                ...
                <li className="mb-10 ml-4">
                  ...
                  <p className="text-sm text-gray-600">Ekart Logistics - FMPC5FDG5G4</p>
                   <p className="text-sm text-gray-600"> <p className="text-sm text-gray-600">Ekart Logistics - FMPC5FDG5G4</p></p>
