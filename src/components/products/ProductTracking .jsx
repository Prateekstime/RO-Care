    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="bg-white shadow rounded p-4 mb-6">
        ...
        <div className="flex items-center gap-4 mt-2">
          <img
            src="https://via.placeholder.com/100" // Replace with actual product image if needed
            alt="Product"
        ...
        <div className="col-span-2 bg-white shadow rounded p-6">
          ...
          <ol className="relative border-l border-gray-300">
            ...
            <li className="mb-10 ml-4">
              ...
              <p className="text-sm text-gray-600">Ekart Logistics - FMPC5D9654<br />Your item has been shipped</p>
              <p className="text-xs text-gray-500">Fri 1st Oct 2025 - 10:30 am</p>
            </li>

            <li className="mb-10 ml-4">
              <div className="absolute w-3 h-3 bg-green-500 rounded-full -left-1.5 top-1.5" />
              <h4 className="font-bold">Out for Delivery</h4>
              <p className="text-sm text-gray-600">Your item is out for delivery</p>
